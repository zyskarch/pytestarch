...
from pytestarch.eval_structure.evaluable_architecture import Module, ModuleNameFilter
...
MODULE_1 = "Module1"
MODULE_FILTER_OBJECT_1 = ModuleNameFilter(name=MODULE_1)
MODULE_OBJECT_1 = Module(identifier=MODULE_1)
MODULE_2 = "Module2"
MODULE_FILTER_OBJECT_2 = ModuleNameFilter(name=MODULE_2)
MODULE_OBJECT_2 = Module(identifier=MODULE_2)
MODULE_3 = "Module3"
MODULE_FILTER_OBJECT_3 = ModuleNameFilter(name=MODULE_3)
MODULE_OBJECT_3 = Module(identifier=MODULE_3)
MODULE_4 = "Module4"
MODULE_FILTER_OBJECT_4 = ModuleNameFilter(name=MODULE_4)
MODULE_OBJECT_4 = Module(identifier=MODULE_4)
MODULE_6 = "Module6"
MODULE_FILTER_OBJECT_6 = ModuleNameFilter(name=MODULE_6)
MODULE_OBJECT_6 = Module(identifier=MODULE_6)
SUB_MODULE_OF_2 = "Module2.SubModule1"
SUB_MODULE_FILTER_OBJECT_2 = ModuleNameFilter(name=SUB_MODULE_OF_2)
SUB_MODULE_OBJECT_2 = Module(identifier=SUB_MODULE_OF_2)
