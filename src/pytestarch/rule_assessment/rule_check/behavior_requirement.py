...
class BehaviorRequirement:
    ...
    def explicitly_requested_dependency_required(self) -> bool:
        ...
        return (self.should or self.should_only) and not self._behavior_exception
    ...
    def not_explicitly_requested_dependency_required(self) -> bool:
        ...
        return self._behavior_exception and (self.should or self.should_only)
    ...
    def explicitly_requested_dependency_not_allowed(self) -> bool:
        ...
        return (self.should_not and not self._behavior_exception) or (
            self.should_only and self._behavior_exception
        )
    ...
    def not_explicitly_requested_dependency_not_allowed(self) -> bool:
        ...
        return (self.should_not and self._behavior_exception) or (
            self.should_only and not self._behavior_exception
        )
